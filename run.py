...
print "Scripts are generated in scripts folder. Use run_slurm.py (and check that the parameters are ok) to submit slurm jobs as follows:\n\n  python run_slurm.py run_terms_extractions.py\n\nLaunch is recommended as another method, see: https://github.com/vsoch/poldracklab-launch\n\nExtractions of terms, corpus, and relationships can be done in parallel, but must be done before run_analysis_setup.job [NOT YET WRITTEN] and before run_inference.job [NOT YET WRITTEN]"
